...
test("order phases for happy path", async () => {
    ...
    // destructure 'unmount' from return value to use t the end of the test
    ...
    // find and click 'new order' button on confirmation apge
...
test("Toppings header is not on summary page if no toppings ordered", async () => {
    ...
    const topiingsHeading = screen.queryByRole("heading", {
        name: /toppings/i,
    });
    expect(topiingsHeading).not.toBeInTheDocument();
});
...
test("Toppings header is not on summary page if toppings ordered, then removed", async () => {
    ...
    const toppingsTotal = screen.getByText("Toppings totla: $", {
        exact: false,
    });
